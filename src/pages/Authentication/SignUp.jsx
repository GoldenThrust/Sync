        ...
        <AuthBackground>
            <form onSubmit={handleSubmit(signUp)} className="flex flex-col justify-center gap-5 h-screen w-3/4 md:w-1/2 items-center">
                ...
                <div className="w-full space-y-2">
                    ...
                    <Button type="button" onClick={googleSignUp} value={<div className="flex justify-center gap-2"><img src={googleIcon} className="w-6" alt="Google Icon" /> Sign up with Google</div>} className="w-full font-bold" />
                </div>
            </form>
