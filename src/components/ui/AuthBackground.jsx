...
export default function AuthBackground({ children }) {
    return <>
        <header className='md:z-10 relative'>
            <Link to="/" className="p-1"> <img src={Sync} alt="Sync Logo" className="w-14 drop-shadow-2xl drop-shadow-amber-50/50"></img><div className="sr-only">Sync</div></Link>
        </header>
